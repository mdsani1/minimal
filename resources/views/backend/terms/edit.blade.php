    ...
    <div class="card mb-4">
        <div class="card-header ">
            <div class="d-flex justify-content-between">
                ...
                <span>
                    <a class="btn btn-primary text-left" href="{{ Route('terms.index') }}" role="button">List</a>
                </span>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="title" placeholder="Enter Title" value="{{ old('title', $term->title) }}" required>
                            @error("title")
