                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="title" placeholder="Enter Title" value="{{ old('title', $category->title) }}" required>
                            @error("title")
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="description" placeholder="Enter Description" value="{{ old('description', $category->description) }}">
                            @error("description")
                                <span class="sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
