        ...
        <div class="">
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="d-flex justify-content-end">
                    ...
                    <a href="{{ route('quotations-zone', $quotation->id) }}" class="btn btn-info mr-2 mt-3">Zone Manage</a>
                    ...
                    <a href="{{ route('quotations.excel',['id' => $quote->id]) }}" class="btn btn-success mr-2 mt-3">Excel</a>
    ...
    @push('js')
        ...
        <script>
            ...
            function qtyCalculation(event) {
                ...
                rate = parseFloat($(tr).find('.rate').text());
                qty = parseFloat($(tr).find('.qty').text());
                ...
                let amountData = $(tr).parent().find('.amount');

                $.each(amountData, function (indexInArray, value) { 
                     if (!isNaN(parseFloat($(value).text()))) {
                        grandTotal += parseFloat($(value).text());
                    }
                });

                // Update the grand total in the footer
                $(tr).parent().parent().find('.grandTotal').text(grandTotal.toFixed(2));
