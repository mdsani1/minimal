                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control mt-2" name="first_person" id="" cols="30" rows="5">{!! $quotation->first_person !!}</textarea>
                                            @error("first_person")
                                                <span class="sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control mt-2" name="second_person" id="" cols="30" rows="5">{!! $quotation->second_person !!}</textarea>
                                            @error("second_person")
                                                <span class="sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-4" style="border-right:1px solid #ddd">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="third_person">Third Person</label>
                                            <textarea class="form-control mt-2" name="third_person" id="" cols="30" rows="5">{!! $quotation->third_person !!}</textarea>
                                            @error("third_person")
                                                <span class="sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-4" style="border-right:1px solid #ddd">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="fourth_person">Fourth Person</label>
                                            <textarea class="form-control mt-2" name="fourth_person" id="" cols="30" rows="5">{!! $quotation->fourth_person !!}</textarea>
                                            @error("fourth_person")
                                                <span class="sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-4" style="border-right:1px solid #ddd">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="fifth_person">Fifth Person</label>
                                            <textarea class="form-control mt-2" name="fifth_person" id="" cols="30" rows="5">{!! $quotation->fifth_person !!}</textarea>
                                            @error("fifth_person")
                                                <span class="sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
